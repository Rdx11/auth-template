<html lang="en">
    ...
    <head>
        ...
        <title>Login - Topson - Tailwind HTML Admin Template</title>
        <!-- BEGIN: CSS Assets-->
            ...
            <div class="intro-y auth">
                ...
                <div class="intro-y box px-5 py-8 mt-16">
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="intro-y text-gray-600 dark:text-gray-300 flex text-xs sm:text-sm mt-2">
                        ...
                        <div class="intro-y mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="btn btn-primary intro-y w-full xl:mr-3">Login</button>
                    </form>
                        <a href="{{ route('register') }}" class="btn btn-outline-secondary intro-y w-full mt-3">Sign up</a>
                        </div>
                </div>
            </div>
        </div>
