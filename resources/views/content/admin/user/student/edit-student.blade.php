            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="grid lg:grid-cols-2 {{ count($errors) > 0 ? 'gap-10' : '' }} gap-6 mt-5">
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('student_exam_number') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="student_exam_number" name="student_exam_number" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('student_exam_number') ?? $student->student_exam_number }}">
                        </p>
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('first_name') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="name" name="first_name" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('first_name') ?? $student->first_name }}">
                        </p>
                        @error('first_name')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('last_name') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="lastname" name="last_name" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('last_name') ?? $student->last_name }}">
                        </p>
                        @error('last_name')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('email') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="username" name="email" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('email') ?? $student->user->email }}">
                        </p>
                        @error('email')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('address') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="address" name="address" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('address') ?? $student->address }}">
                        </p>
                        @error('address')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                        ...
                        <p>
                        <input id="zip_code" name="zip_code" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('zip_code') ?? $student->zip_code }}">
                        </p>
                    </div>
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('phone') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="phone" name="phone" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('phone') ?? $student->phone }}">
                        </p>
                        @error('phone')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('class') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="class" name="class" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('class') ?? $student->class }}">
                        </p>
                        @error('class')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('majors') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="majors" name="majors" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('majors') ?? $student->majors }}">
                        </p>
                        @error('majors')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('age') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="age" name="age" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('age') ?? $student->age }}">
                        </p>
                        @error('age')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                        ...
                        <p>
                        <input id="hobby" name="hobby" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('hobby') ?? $student->hobby }}">
                        </p>
                    </div>
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('place_of_birth') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="place_of_birth" name="place_of_birth" autocomplete="true" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('place_of_birth') ?? $student->place_of_birth }}">
                        </p>
                    ...
                    <div class="border-2 focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1 @error('date_of_birth') border-2 border-red-400 @enderror">
                        ...
                        <p>
                        <input id="date_of_birth" name="date_of_birth" autocomplete="true" tabindex="0" type="date" class="py-1 px-1 outline-none block h-full w-full" value="{{ old('date_of_birth') ?? $student->date_of_birth }}">
                        </p>
                        @error('date_of_birth')
                        <div class="absolute">
                            <p class="text-red-400 mt-3 -ml-1 font-medium">
                ...
                <div class="flex mt-6 pt-3">
                    ...
                    <button class="btn border-blue-500 border text-blue-500  hover:bg-blue-700 hover:text-white focus:outline-none mb-5 mr-5">update</button>
                </div>
            </div>
        </form>
    </div>
